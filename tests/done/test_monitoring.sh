...
# Test suite for system monitoring and diagnostics collection
source "${PARENT_DIR}/config/dashboard_config.conf"
...
setup() {
    ...
    TEST_ROOT="/mnt/c/temp/monitor_test_$(date +%s)"
    TEST_DATA_DIR="$TEST_ROOT/data"
    TEST_ARCHIVE_DIR="$TEST_ROOT/archives"
